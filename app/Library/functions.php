...
function saveNotification($userId, $title,$title_ar , $message, $message_ar ,$id = null) {

        $created =\App\Models\Notification::create(['user_id'=> $userId, 'title'=> $title,'title_ar'=>$title_ar,
            'description'=> $message,'description_ar'=> $message_ar,'order_id'=>$id]);
        return $created;
