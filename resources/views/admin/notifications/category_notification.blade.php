...
@section('title')
@lang('messages.send_notification_to_a_group_of_users')
@endsection
...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('/admin/general-notifications')}}"> @lang('messages.send_notification_to_a_group_of_users')
    ...
    <h1 class="page-title">@lang('messages.send_notification_to_a_group_of_users')
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="portlet light ">
                            ...
                            <form method="post" action="{{route('notifications.category')}}" enctype="multipart/form-data" >
                                                ...
                                                <div class="portlet-body form">
                                                    <div class="form-horizontal" role="form">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-md-3 control-label">@lang('messages.category')</label>
                                                                <div class="col-md-9">
                                                                    <select name="category"
                                                                            class="form-control ">
                                                                        <option value="" disabled
                                                                                selected>@lang('messages.category')
                                                                        </option>
                                                                        <option value="2">@lang('messages.employees')
                                                                        </option>
                                                                        <option value="1">@lang('messages.clients')
                                                                        </option>
