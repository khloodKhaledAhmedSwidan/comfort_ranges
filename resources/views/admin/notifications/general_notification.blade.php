...
@section('title')
@lang('messages.send_notifications_for_all_customers')
@endsection
...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('/admin/general-notifications')}}">@lang('messages.send_notifications_for_all_customers')
    ...
    <h1 class="page-title">@lang('messages.send_notifications_for_all_customers')
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="portlet light ">
                            ...
                            <form method="post" action="{{route('notifications.general')}}" enctype="multipart/form-data" >
