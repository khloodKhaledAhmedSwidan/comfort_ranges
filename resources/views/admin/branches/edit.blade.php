...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="/admin/branches">@lang('messages.branches')</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>   @lang('messages.edit_branch')</span>
            </li>
        </ul>
    </div>

    <h1 class="page-title"> @lang('messages.branches')
        <small>   @lang('messages.edit_branch')</small>
    </h1>
@endsection
                        ...
                        <div class="portlet light ">
                            <div class="portlet-title tabbable-line">
                                <div class="caption caption-md">
                                    ...
                                    <span class="caption-subject font-blue-madison bold uppercase"> @lang('messages.edit_branch')</span>
                                </div>
                            ...
                            <div class="portlet-body">
                                <div class="tab-content">
                                    <!-- PERSONAL INFO TAB -->
                                        ...
                                        <form role="form" action="{{route('branches.update',$branch->id)}}" method="post" enctype="multipart/form-data">
                                            <input type = 'hidden' name = '_token' value = '{{Session::token()}}'>
                                            @method('put')
                                            <div class="form-group">
                                                <label class="control-label">@lang('messages.name_of_branch')</label>
                                                <input type="text" name="name_ar" placeholder="@lang('messages.name_of_branch')" class="form-control" value="{{$branch->name_ar}}" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" placeholder=" @lang('messages.name_of_branch_en')" class="form-control" value="{{$branch->name}}" />
                                                @if ($errors->has('name'))
                                                    <span class="help-block">
                                            ...
                                            <div class=" form-group " id="hide-map">
                                                ...
                                                <div class="content sections">
                                                    ...
                                                    <!--<input type="number" id="lat" name="" class="form-control mb-2"-->
                                                    <!--        value="{{$branch->latitude}}" required/>-->
                                                            
                                        <input type="text" id="latitude" name="latitude" class="form-control mb-2" value="{{$branch->latitude}}" readonly="yes" required>                    
                            ...
                            <strong style="color: red;">{{ $errors->first('latitude') }}</strong>
                                                    ...
                                                    <!--<input type="number" id="lng" name="longitude" class="form-control mb-2"-->
                                                    <!--      value="{{$branch->longitude}}" required/>-->
                                        <input type="text" id="longitude" name="longitude" class="form-control mb-2" value="{{$branch->longitude}}" readonly="yes" required>                  
