...
@section('title')
@lang('messages.all_client_records')
@endsection
...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>@lang('messages.show_all_client_records')</span>
            </li>
        </ul>
    </div>

    <h1 class="page-title">@lang('messages.show_all_client_records')
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> @lang('messages.all_client_records')</span>
                    </div>
            ...
            $phone = '00966' . $result;
                          ...
                          {{$client->userOrders()->count()}}
                                ...
                                <td>
                                        ...
                                        <a class="btn btn-info btn-sm" href="{{route('show_client_records',$client->id)}}"  >
