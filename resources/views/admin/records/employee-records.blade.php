...
@section('title')
    @lang('messages.employee_records')
@endsection
...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                i>
                <a href="/admin/all-employee-records">@lang('messages.all_employee_records')</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>@lang('messages.show_employee_records')  </span>
            </li>
        </ul>
    </div>

    <h1 class="page-title">@lang('messages.employee_records')
        <small>@lang('messages.show_employee_records')</small>
    </h1>
@endsection
