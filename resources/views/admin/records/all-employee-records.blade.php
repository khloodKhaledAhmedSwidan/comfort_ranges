...
@section('title')
@lang('messages.all_employee_records')
@endsection
...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>@lang('messages.show_all_employee_records')</span>
            </li>
        </ul>
    </div>

    <h1 class="page-title">@lang('messages.show_all_employee_records')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> @lang('messages.all_employee_records')</span>
                    </div>
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        <tr>
                            ...
                            <th>@lang('messages.orders_number')</th>
            ...
            $phone = '00966' . $result;
                          ...
                          {{$user->employeeOrders()->where('status',2)->count() + $user->employeeOrders()->where('status',5)->count()}}
                                ...
                                <td>
                                        ...
                                        <a class="btn btn-info btn-sm" href="{{route('show_employee_records',$user->id)}}"  >
                                            <i class="fa fa-key"></i> @lang('messages.show')
                                        </a>
