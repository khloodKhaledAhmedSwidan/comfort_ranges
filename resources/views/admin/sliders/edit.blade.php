...
@section('page_header')
    ...
    <h1 class="page-title">@lang('messages.edit_slider')
    </h1>
@endsection
                        ...
                        <div class="portlet light ">
                            <div class="portlet-title tabbable-line">
                                <div class="caption caption-md">
                                    ...
                                    <span
                                        class="caption-subject font-blue-madison bold uppercase">@lang('messages.edit_slider')</span>
                                </div>
                                                ...
                                                <div class="tab-pane active" id="tab_1_1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="link" class="form-control"
                                                               placeholder="@lang('messages.link_slider') " value="{{$slider->link}}"/>
                                                        @if ($errors->has('link'))
                                                ...
                                                <strong style="color: red;">{{ $errors->first('link') }}</strong>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select  class="form-control" name="category_id">
                                                            <option value="{{ $slider->category_id != null ?\App\Models\Category::find($slider->category_id)->id:'اختر خدنة'}}"
                                                                    selected>{{ $slider->category_id != null ? app()->getLocale() =='en'?\App\Models\Category::find($slider->category_id)->name:\App\Models\Category::find($slider->category_id)->name_ar: 'اختر خدمة'}}</option>
                                                            @foreach(\App\Models\Category::all() as $category)
                                                                @if ($slider->category_id != null ? ($category::find($slider->category_id)->id != $category->id) : ' ')
