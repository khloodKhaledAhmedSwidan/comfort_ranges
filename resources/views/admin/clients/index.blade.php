...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>@lang('messages.show_clients') </span>
            </li>
        </ul>
    </div>

    <h1 class="page-title">@lang('messages.show_clients')
        <small>@lang('messages.show_all_clients')</small>
    </h1>
@endsection
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="btn-group">
                                <a class="btn sbold green" href="/admin/add/client">@lang('messages.new_addition')
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        @foreach($clients as $client)
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <input type="checkbox" id="activation-{{$client->id}}"
                                           onchange="testActive({{$client->active}},{{$client->id}})"
                                           {{$client->active == 1 ? 'checked' : ''}} data-toggle="toggle">
                                </td>
...
{{--                                        <ul class="dropdown-menu pull-left" role="menu">--}}
                                            ...
                                            {{--</li>--}}
{{--                                            <li>--}}
                                                <a class="btn btn-info btn-sm" style="margin-left: 2rem;" href="/admin/edit/client/{{$client->id}}">
                                                    <i class="icon-docs"></i> @lang('messages.update') </a>
{{--                                            </li>--}}
                                            {{--                                            @if( auth()->user()->id != $value->id )--}}
{{--                                            <li>--}}
                                                <a class="delete_user btn-sm btn btn-danger" data="{{ $client->id }}" data_name="{{ $client->name }}" >
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_user', function() {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/admin/delete/"+id+"/client";
