<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="">
                <img src="{{ asset('img/'.App\Models\Setting::find(1)->image) }}" style="width: 104px;" alt="logo" class="logo-default" height="50"/> </a>
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                        <li>
                            <a href="/admin/profile">
                                <i class="icon-user"></i> @lang('messages.personal_page') </a>
                        </li>
                        <li>
                            <a href="/admin/profileChangePass">
                                <i class="icon-user"></i> @lang('messages.change_password') </a>
                        </li>
                        {{--<li>--}}
                        ...
                        <li>
                            <a onclick="document.getElementById('logout_form').submit()">
                                <i class="icon-key"></i>@lang('messages.logout')
                            </a>
                        </li>
                    </ul>
                </li>
