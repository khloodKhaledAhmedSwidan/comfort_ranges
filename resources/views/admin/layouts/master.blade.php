...
<head>
    ...
    <link type="text/css" rel="icon" href="{{asset('images/logo.jpg')}}" type="image/x-icon">
...
<!-- END HEADER -->
    ...
    <div class="page-footer">
        <div class="page-footer-inner"> {{ date('Y') }} &copy; @lang('messages.Developed_by')
            <a target="_blank" href="https://www.tqnee.com.sa/"> @lang('messages.tqnyee'). </a>
        </div>
