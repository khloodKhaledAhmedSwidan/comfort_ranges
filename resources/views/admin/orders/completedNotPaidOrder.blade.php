...
@section('title')
@lang('messages.completed_ordersNotPaid')
@endsection
...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('/admin/completed_orders-not-paid')}}"> @lang('messages.completed_ordersNotPaid')
                </a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span> @lang('messages.completed_ordersNotPaid')
 </span>
            </li>
        </ul>
    </div>

    <h1 class="page-title"> @lang('messages.completed_ordersNotPaid')

        <small>@lang('messages.show_completed_orders')</small>
    </h1>
@endsection
...
{{--                            <th>@lang('messages.start_order')</th>--}}
{{--                            <th>@lang('messages.end_order')</th>--}}
                            <th>@lang('messages.Duration_taken')</th>
...
{{--                                <td>{{\Carbon\Carbon::parse($order->from)->format('h:i') }}</td>--}}
{{--                                <td>{{\Carbon\Carbon::parse($order->to)->format('h:i') }}</td>--}}
                                <td>{{ \Carbon\Carbon::parse($order->work_duration)->format('h:i')}}</td>
                                <td> <form method="post" action="{{route('changeOrderStatus',$order->id)}}">
                                        @csrf
...
{{--                                            <li>--}}
                                        ...
                                        <a class="btn btn-info btn-sm" href="{{route('showBill',$order->id)}}">
