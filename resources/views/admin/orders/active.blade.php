...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('/admin/active-orders')}}">@lang('messages.active_orders')</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>@lang('messages.active_orders')  </span>
            </li>
        </ul>
    </div>

    <h1 class="page-title">@lang('messages.active_orders')
...
{{--                            <th> @lang('messages.period') </th>--}}
                        ...
                        @foreach($orders as $order)
                            <tr class="odd gradeX">
                                ...
                                <td>{{$order->date}}</td>
{{--                                <td>@lang('messages.from'){{ \App\Models\OrderShift::find($order->order_shift_id)->from }}@lang('messages.to'){{\App\Models\OrderShift::find($order->order_shift_id)->to  }} </td>--}}
                                <td>
