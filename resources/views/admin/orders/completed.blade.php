...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('/admin/completed-orders')}}">@lang('messages.completed_orders')</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>@lang('messages.completed_orders')  </span>
            </li>
        </ul>
    </div>

    <h1 class="page-title">@lang('messages.completed_orders')
...
{{--                            <th>@lang('messages.end_order')</th>--}}
                            ...
                            <th>@lang('messages.Status_evaluation')</th>
...
{{--<td>{{\Carbon\Carbon::parse($order->to)->format('h:i') }}</td>--}}
                              ...
                              $rate = $value_of_rate == 3 ?'ممتاز':($value_of_rate == 2 ?'جيد':($value_of_rate == 1 ?'سئ':'لا يوجد تقييم بعد'));
