...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('/admin/canceled-orders')}}">@lang('messages.canceled_orders')</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>@lang('messages.canceled_orders')  </span>
            </li>
        </ul>
    </div>

    <h1 class="page-title">@lang('messages.canceled_orders')
