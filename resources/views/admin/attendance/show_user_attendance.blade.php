                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="btn-group">
                                    <p> @lang('messages.Client_attendance_and_departure_statement') {{$user->name}}</p>
                                </div>
                            </div>
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        <tr>
                            ...
                            <th>  @lang('messages.Attendance')</th>
                            <th> @lang('messages.check_out') </th>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    @if($shift->to != null)
                                        ...
                                        <td>
                                            ...
                                            {{$diff->h}}  @lang('messages.hours') {{$diff->i}} @lang('messages.minute')
                                        </td>
